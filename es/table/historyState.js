    ...
    if (
      ...
      return [
        isSet
          ? v0
          : (0, _moment.default)(
              (_value$3 = value[0]) === null || _value$3 === void 0 ? void 0 : _value$3.value,
            ),
        isSet
          ? v1
          : (0, _moment.default)(
              (_value$4 = value[1]) === null || _value$4 === void 0 ? void 0 : _value$4.value,
            ),
      ]
    }
...
function setHistoryState(query) {
  ...
  history.replaceState(
    _objectSpread({}, state, (0, _defineProperty2.default)({}, key, handler(query, true))),
    '',
    pathname + search,
  )
}
