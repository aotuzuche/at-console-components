...
var _QuestionCircleOutlined = _interopRequireDefault(
...
var InternalForm = function InternalForm(_ref) {
  ...
  ;(0, _react.useEffect)(
    function() {
      if (
        ...
        !(0, _isEqual.default)(prevFormInitialValues, initialValuesInternal)
      ) {
  ...
  var onFinish = /*#__PURE__*/ (function() {
    var _ref5 = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/ _regenerator.default.mark(function _callee2(values) {
        return _regenerator.default.wrap(
  ...
  var renderItems = function renderItems(_ref8, index) {
    var render = _ref8.render,
      ...
      extra = _ref8.extra,
      itemProps = (0, _objectWithoutProperties2.default)(_ref8, [
        'render',
        'renderView',
        'isView',
        'isHidden',
    ...
    if (isItemView) {
      Comp = (0, _showPlaceholder.default)(
        renderView && (0, _is.isFunc)(renderView)
  ...
  var FormChildren = /*#__PURE__*/ _react.default.createElement(
    _row.default,
    {
      gutter: 24,
    },
