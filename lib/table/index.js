...
function Table(_ref, ref) {
  var tableSearchProps = _ref.searchProps,
      ...
      props = (0, _objectWithoutProperties2.default)(_ref, ["searchProps", "onSearch", "pagination", "totalName", "pageSize", "pageSizeName", "pageNum", "pageNumName", "dataName", "onChange", "columns", "placeholder", "title", "showTools", "scroll", "isKeepAlive"]);
  ...
  var onSearch = /*#__PURE__*/function () {
    var _ref2 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(params, changeState) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              searchParams = _objectSpread({}, pagination === false ? {} : (_ref3 = {}, (0, _defineProperty2.default)(_ref3, pageNumName, state.pageNum), (0, _defineProperty2.default)(_ref3, pageSizeName, pageSize), _ref3), {}, params, {}, searchValues);
              _context.next = 6;
  ...
  var renderColumns = function renderColumns() {
    return columns === null || columns === void 0 ? void 0 : columns.map(function (_ref4) {
  ...
  var renderSearchColumns = function renderSearchColumns() {
    ...
    var _tableSearchProps$ini = tableSearchProps.initialCount,
        ...
        searchProps = (0, _objectWithoutProperties2.default)(tableSearchProps, ["initialCount", "items"]);
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_form2.default, (0, _extends2.default)({
      items: state.isExpand ? items : items.slice(0, initialCount),
      form: form,
      layoutCol: {
        span: 6
      }
    }, searchProps), /*#__PURE__*/_react.default.createElement(_row.default, {
      justify: "end"
    ...
    }, state.isExpand ? '收起' : '展开', /*#__PURE__*/_react.default.createElement(_DownOutlined.default, {
      rotate: state.isExpand ? 180 : 0
    }))))), isShowTableTitle && /*#__PURE__*/_react.default.createElement(_divider.default, {
      style: {
        margin: 0
      }
    }));
  ...
  var renderTitle = function renderTitle() {
    ...
    }, /*#__PURE__*/_react.default.createElement(_col.default, null, title && title(state.data)), showTools && /*#__PURE__*/_react.default.createElement(_col.default, null, /*#__PURE__*/_react.default.createElement(_tooltip.default, {
      title: "\u5237\u65B0"
  ...
  var onInit = function onInit() {
    ...
    onSearch(_objectSpread((0, _defineProperty2.default)({}, pageNumName, historyPageNum), isKeepAlive ? (0, _historyState.getHistoryState)() : {}), {
      isInit: true
    });
  };
  ...
  return /*#__PURE__*/_react.default.createElement("div", null, renderSearchColumns(), /*#__PURE__*/_react.default.createElement(_table.default, (0, _extends2.default)({}, props, {
    tableLayout: "auto",
